...
export default function Song({ data, limit }: any) {
  ...
  return (
    <div className="flex flex-row items-center justify-between p-2 overflow-hidden transition-shadow bg-white shadow-sm w-80 sm:4 rounded-xl hover:shadow-md">
